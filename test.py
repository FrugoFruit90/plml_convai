...
parser.add_argument('--no_models', type=int, default=10, help='how many models to evaluate')
...
parser.add_argument('--model_path', type=str, default='model/model/model.ckpt', help='Path to a specific model checkpoint.')
...
def decode(num=1):
    ...
    for ii in range(2):
        ...
        with open(args.valid_output + 'val_dials_gen_' + str(num) + '.json', 'w') as outfile:
        ...
        with open(args.decode_output + 'test_dials_gen_' + str(num) + '.json', 'w') as outfile:
